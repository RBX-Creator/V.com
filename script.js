...
const ICO = {
  ...
  like: `<svg class="ico" viewBox="0 0 24 24" aria-hidden="true"><path d="M16.697 5.5c-1.222-.06-2.679.51-3.89 2.16l-.805 1.09-.806-1.09C9.984 6.01 8.526 5.44 7.304 5.5c-1.243.07-2.349.78-2.91 1.91-.552 1.12-.523 2.58.436 4.19.96 1.61 2.844 3.46 5.766 5.71l.502.37.503-.37c2.922-2.25 4.807-4.1 5.766-5.71.959-1.61.988-3.07.436-4.19-.561-1.13-1.667-1.84-2.91-1.91zM12 21.368l-.697-.52C4.844 14.868 1 10.95 1 7.348 1 4.654 3.13 2.5 5.82 2.5c1.626 0 3.16.804 4.18 2.09C11.02 3.304 12.554 2.5 14.18 2.5 16.87 2.5 19 4.654 19 7.348c0 3.603-3.844 7.52-10.303 13.5L12 21.368z"/></svg>`,
