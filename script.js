...
function verifiedBadgeHtml(profile) {
  if (profile && (profile.verified || isOwnerProfile(profile))) {
    // Blue flower badge + white check (like the provided icon, no white bg)
    return `<span class="verified-badge" title="Verified" aria-label="Verified"><svg viewBox="0 0 24 24" width="18" height="18" class="verified-svg" xmlns="http://www.w3.org/2000/svg"><path fill="#1D9BF0" d="M12 0c.9 0 1.4.5 2 1.1.6.6 1.4.6 2.1.4.7-.2 1.4 0 1.9.6s.6 1.4 1.1 2c.5.6 1.3.8 1.8 1.4.5.6.4 1.4.2 2.1-.2.7 0 1.5.6 1.9.6.5.8 1.3.8 2.1s-.2 1.6-.8 2.1c-.6.4-.8 1.2-.6 1.9.2.7.3 1.5-.2 2.1-.5.6-1.3.8-1.8 1.4-.5.6-.6 1.4-1.1 2s-1.2.8-1.9.6c-.7-.2-1.5-.2-2.1.4-.6.6-1.1 1.1-2 1.1s-1.4-.5-2-1.1c-.6-.6-1.4-.6-2.1-.4-.7.2-1.4 0-1.9-.6s-.6-1.4-1.1-2c-.5-.6-1.3-.8-1.8-1.4-.5-.6-.4-1.4-.2-2.1.2-.7 0-1.5-.6-1.9C.7 13.6.5 12.8.5 12s.2-1.6.8-2.1c.6-.4.8-1.2.6-1.9-.2-.7-.3-1.5.2-2.1.5-.6 1.3-.8 1.8-1.4.5-.6.6-1.4 1.1-2s1.2-.8 1.9-.6c.7.2 1.5.2 2.1-.4C10.6.5 11.1 0 12 0z"/><path fill="#FFFFFF" d="M10.05 15.45L6.9 12.3l1.45-1.45 1.7 1.7 5.35-5.35 1.45 1.45-6.8 6.8z"/></svg></span>`
  }
  return "";
}
